    ...
    b.fn.gmuAllPage = function (c) {
        ...
        function z(a, d) {
            if (l[a]) {
                if ("down" ==
                    a) var c = "bottom",
                    f = b.fn.gmuAllPage.moveSectionDown; else c = "top", f = b.fn.gmuAllPage.moveSectionUp;
        ...
        function sa(a) {
            ...
            if (!W(a.target)) {
                ...
                m || t || (d = X(d), u = d.y, A = d.x, a.find(".fp-slides").length && Math.abs(B - A) > Math.abs(v - u) ? Math.abs(B - A) > b(window).width() / 100 * c.touchSensitivity &&
                    (B > A ? l.right && b.fn.gmuAllPage.moveSlideRight() : l.left && b.fn.gmuAllPage.moveSlideLeft()) : c.autoScrolling && !c.scrollBar && Math.abs(v - u) > b(window).height() / 100 * c.touchSensitivity && (v > u ? z("down", e) : u > v && z("up", e)))
            }
        }
        ...
        function ga() {
            ...
            if (C) {
                if ("text" !== b(document.activeElement).attr("type")) {
                    ...
                    Math.abs(a - M) > 20 * Math.max(M, a) / 100 && (b.fn.gmuAllPage.reBuild(!0),
                        M = a)
                }
            } else clearTimeout(ia), ia = setTimeout(function () {
                b.fn.gmuAllPage.reBuild(!0)
            }, 500);
            if (c.miniresize) {
                b.fn.gmuAllPage.reBuild(!0)
            }
        ...
        function ha() {
            if (c.responsive) {
                ...
                b(window).width() < c.responsive ? a || (b.fn.gmuAllPage.setAutoScrolling(!1, "internal"), b("#fp-nav").hide(), g.addClass("fp-responsive")) : a && (b.fn.gmuAllPage.setAutoScrolling(N.autoScrolling, "internal"), b("#fp-nav").show(), g.removeClass("fp-responsive"))
            }
        }
        ...
        function J(a) {
            b.fn.gmuAllPage.setScrollingSpeed(0, "internal");
            w(a.closest(".fp-slides"), a);
            b.fn.gmuAllPage.setScrollingSpeed(N.scrollingSpeed, "internal")
        }
        ...
        function E(a, b) {
            console && console[a] && console[a]("gmuAllPage: " + b)
        }
        ...
        b.fn.gmuAllPage.setAutoScrolling = function (a, d) {
            Q("autoScrolling", a, d);
            var e = b(".fp-section.active");
            c.autoScrolling && !c.scrollBar ? (b("html, body").css({
                overflow: "hidden",
                height: "100%"
            }), b.fn.gmuAllPage.setRecordHistory(c.recordHistory, "internal"), g.css({
                "-ms-touch-action": "none",
                "touch-action": "none"
            }), e.length && n(e.position().top)) : (b("html, body").css({
                overflow: "visible",
                height: "initial"
            }), b.fn.gmuAllPage.setRecordHistory(!1, "internal"), g.css({
                "-ms-touch-action": "",
                "touch-action": ""
            }), n(0), b("html, body").scrollTop(e.position().top))
        };
        b.fn.gmuAllPage.setRecordHistory = function (a, b) {
            Q("recordHistory", a, b)
        };
        b.fn.gmuAllPage.setScrollingSpeed = function (a, b) {
            Q("scrollingSpeed", a, b)
        };
        b.fn.gmuAllPage.setMouseWheelScrolling = function (a) {
        ...
        b.fn.gmuAllPage.setAllowScrolling = function (a, c) {
            if ("undefined" != typeof c) c = c.replace(" ", "").split(","), b.each(c, function (c, d) {
                switch (d) {
                    ...
                    case "right":
                        ...
                        break;
                    case "all":
                        b.fn.gmuAllPage.setAllowScrolling(a)
                }
            }); else if (a) {
                if (b.fn.gmuAllPage.setMouseWheelScrolling(!0), C || P) MSPointer = oa(), b(document).off("touchstart " + MSPointer.down).on("touchstart " + MSPointer.down, ta), b(document).off("touchmove " +
                    MSPointer.move).on("touchmove " + MSPointer.move, sa)
            } else if (b.fn.gmuAllPage.setMouseWheelScrolling(!1), C || P) MSPointer = oa(), b(document).off("touchstart " + MSPointer.down), b(document).off("touchmove " + MSPointer.move)
        };
        b.fn.gmuAllPage.setKeyboardScrolling = function (a) {
            c.keyboardScrolling = a
        };
        b.fn.gmuAllPage.moveSectionUp = function () {
            var a = b(".fp-section.active").prev(".fp-section");
            a.length || !c.loopTop && !c.continuousVertical || (a = b(".fp-section").last());
            a.length && q(a, null, !0)
        };
        b.fn.gmuAllPage.moveSectionDown = function () {
            var a =
                b(".fp-section.active").next(".fp-section");
            a.length || !c.loopBottom && !c.continuousVertical || (a = b(".fp-section").first());
            a.length && q(a, null, !1)
        };
        b.fn.gmuAllPage.moveTo = function (a, c) {
            var e = "", e = isNaN(a) ? b('[data-anchor="' + a + '"]') : b(".fp-section").eq(a - 1);
            "undefined" !== typeof c ? L(a, c) : 0 < e.length && q(e)
        };
        b.fn.gmuAllPage.moveSlideRight = function () {
            Y("next")
        };
        b.fn.gmuAllPage.moveSlideLeft = function () {
            Y("prev")
        };
        b.fn.gmuAllPage.reBuild = function (a) {
            x = !0;
        ...
        var t = !1,
            ...
            h = b(window).height(), m = !1, x = !1, p, K, k, ca = "gmuAllPage-wrapper",
            l = {up: !0, down: !0, left: !0, right: !0}, N = jQuery.extend(!0, {}, c);
        b.fn.gmuAllPage.setAllowScrolling(!0);
        c.css3 && (c.css3 = za());
        b(this).length ? (g.css({
            height: "100%",
            position: "relative"
        }), g.addClass(ca)) : E("error", "Error! gmuAllPage.js needs to be initialized with a selector. For example: $('#myContainer').gmuAllPage();");
        ...
        b(".fp-section").each(function (a) {
            ...
            b.fn.gmuAllPage.setAutoScrolling(c.autoScrolling, "internal");
            ...
            c.menu && c.css3 && b(c.menu).closest(".gmuAllPage-wrapper").length && b(c.menu).appendTo("body");
        ...
        b(document).keydown(function (a) {
            if (c.keyboardScrolling && c.autoScrolling && (40 != a.which && 38 != a.which || a.preventDefault(),
                ...
                case 38:
                case 33:
                    b.fn.gmuAllPage.moveSectionUp();
                    break;
                case 40:
                case 34:
                    b.fn.gmuAllPage.moveSectionDown();
                    break;
                case 36:
                    b.fn.gmuAllPage.moveTo(1);
                    break;
                case 35:
                    b.fn.gmuAllPage.moveTo(b(".fp-section").length);
                    break;
                case 37:
                    b.fn.gmuAllPage.moveSlideLeft();
                    break;
                case 39:
                    b.fn.gmuAllPage.moveSlideRight()
            }
        });
        ...
        c.normalScrollElements && (b(document).on("mouseenter", c.normalScrollElements, function () {
            b.fn.gmuAllPage.setMouseWheelScrolling(!1)
        }), b(document).on("mouseleave", c.normalScrollElements, function () {
            b.fn.gmuAllPage.setMouseWheelScrolling(!0)
        }));
        b(".fp-section").on("click touchstart", ".fp-controlArrow", function () {
            b(this).hasClass("fp-prev") ? b.fn.gmuAllPage.moveSlideLeft() : b.fn.gmuAllPage.moveSlideRight()
        });
        b(window).resize(ga);
        var M = h, ia;
        b.fn.gmuAllPage.destroy = function (a) {
            b.fn.gmuAllPage.setAutoScrolling(!1, "internal");
            b.fn.gmuAllPage.setAllowScrolling(!1);
            b.fn.gmuAllPage.setKeyboardScrolling(!1);
